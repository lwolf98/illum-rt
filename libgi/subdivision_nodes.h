...
namespace subd {
...
#ifdef QUANTIZATION
	//static constexpr uint32_t size_xz = 8;
	//static constexpr uint32_t size_y = 4;
	...
	//static constexpr float thresholds_xz[size_xz] = { 0.00f, 0.125f, 0.25f, 0.375f, 0.50f, 0.625f, 0.75f, 0.875f };
	//static constexpr float thresholds_y[size_y] = { 0.00f, 0.25f, 0.50f, 0.75f };
